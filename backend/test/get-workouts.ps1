# PowerShell script to test GET /api/workouts
# Usage: .\get-workouts.ps1
...
$response = Invoke-RestMethod -Uri "http://localhost:4000/api/workouts" -Method Get -Headers $headers
