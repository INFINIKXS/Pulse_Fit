# PowerShell script to test POST /api/activities
...
$response = Invoke-RestMethod -Uri "http://localhost:4000/api/activities" -Method Post -Headers $headers -Body ($body | ConvertTo-Json)
