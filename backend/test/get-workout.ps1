# PowerShell script to test GET /api/workouts/:id
# Usage: .\get-workout.ps1

# Prompt for WorkoutId if not provided
$WorkoutId = Read-Host "Enter the WorkoutId to fetch"
...
$response = Invoke-RestMethod -Uri "http://localhost:4000/api/workouts/$WorkoutId" -Method Get -Headers $headers
