# PowerShell script to test DELETE /api/workouts/:id
# Usage: .\delete-workout.ps1

# Prompt for WorkoutId if not provided
$WorkoutId = Read-Host "Enter the WorkoutId to delete"
...
$response = Invoke-RestMethod -Uri "http://localhost:4000/api/workouts/$WorkoutId" -Method Delete -Headers $headers
