# PowerShell script to test GET /api/activities/:id
# Usage: .\get-activity.ps1

# Prompt for ActivityId if not provided
$ActivityId = Read-Host "Enter the ActivityId to fetch"
...
$response = Invoke-RestMethod -Uri "http://localhost:4000/api/activities/$ActivityId" -Method Get -Headers $headers
