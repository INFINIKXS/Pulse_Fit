...
The objective was to allow users to select a profile picture from the device gallery during onboarding (`OnboardingScreen1`) and in the `ProfileScreen`, and upload it to the backend (Supabase storage via a custom Express API).
